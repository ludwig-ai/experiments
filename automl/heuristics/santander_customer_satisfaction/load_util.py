...
# begin from ludwig.utils.dataset_utils import get_repeatable_train_val_test_split
import pandas as pd
...
def get_repeatable_train_val_test_split(
    ...
    return df_split
# end from ludwig.utils.dataset_utils import get_repeatable_train_val_test_split


def load_santander_customer_satisfaction():
    sant_df = santander_customer_satisfaction.load()
    return get_repeatable_train_val_test_split(sant_df, 'TARGET', random_seed=42)
