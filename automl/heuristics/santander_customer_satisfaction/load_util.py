...
def load_santander_customer_satisfaction():
    train_df = santander_customer_satisfaction.load()
    ...
    val_df['split'] = 1
    test_df['split'] = 2
    santander_customer_satisfaction_df = pd.concat([train_df, val_df, test_df], ignore_index=True)
    return santander_customer_satisfaction_df
